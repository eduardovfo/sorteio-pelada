            ...
            <ul className="space-y-3">
              {time.jogadores.map((esc) => (
                ...
                >
                  ...
                  <span className="flex-1 font-semibold text-gray-900 dark:text-slate-100">{esc.jogador.nome}</span>
                  <span className="text-green-600 dark:text-emerald-400">{esc.posicao} ({esc.notaNaPosicao})</span>
                </li>
              ))}
            </ul>
          </div>
