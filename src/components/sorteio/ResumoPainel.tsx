...
export function ResumoPainel({
  ...
  return (
    <section className="card-animate grid gap-3 rounded-3xl border border-gray-200 bg-white p-4 text-sm shadow-md transition-colors dark:border-slate-800 dark:bg-slate-900/70 dark:shadow-soft-card md:grid-cols-3">
      <div className="flex flex-col gap-2 border-b border-gray-200 pb-3 md:border-b-0 md:border-r md:pb-0 md:pr-4 dark:border-slate-800">
      ...
      <div className="flex flex-col gap-2 border-b border-gray-200 pb-3 md:border-b-0 md:border-r md:pb-0 md:px-4 dark:border-slate-800">
