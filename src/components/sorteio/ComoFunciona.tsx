...
export function ComoFunciona() {
  return (
    <section className="card-animate mt-3 rounded-3xl border border-gray-200 bg-white p-3 text-[11px] text-gray-600 transition-colors dark:border-slate-800 dark:bg-slate-900/70 dark:text-slate-300 lg:mt-4 lg:p-4 lg:text-xs 2xl:mt-5 2xl:p-5">
